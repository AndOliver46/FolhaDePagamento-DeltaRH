...
namespace DeltaRHWebSite.Models
{
    ...
    public class FolhaDePagamento
    {
        ...
        public FolhaDePagamento(decimal valor_folhafinal, decimal valor_desc_total, decimal horas_trab, decimal salario_liq, DateTime? periodo_inicio, DateTime? periodo_fim, int id_empresa, Empresa? empresa)
        {
